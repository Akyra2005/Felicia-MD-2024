...
let handler = async (m, { usedPrefix }) => {
    ...
    if (user.health < 395) return m.reply(`
...
`.trim())
if (user.stamina < 395) return m.reply(`
...
`.trim())
    ...
    let text = `*Anda Telah Berpetualang Ke Arah Utara Dan Sampai Di ${pickRandom(['Amerika Serikat', 'Kanada', 'Russia', 'Inggris', 'Jerman', 'Prancis', 'Jepang', 'China','India'])}`
