...
let handler = async (m, {
    ...
    let keyList = ['suEDMwhi7cxiFM79fHfRzpi8', 'hz99DPWitBbRAgnjTrtG3rEF', 'aGSQ7rF4TnnUeytKEbX72fSN']
    ...
    await conn.sendFile(m.chat, buffer, '', '*Sukses*', m)
} catch (e) {
            try {
            ...
            await conn.sendFile(m.chat, Buffer.from(await response.arrayBuffer()), '', '*Made by:* api.remove.bg', m)            
            }
        }
    } else {
