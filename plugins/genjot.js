...
if (command == 'genjot') {
if (!text) throw `Format: *.genjot Nama*`
...
if (command == 'nenen') {
if (!text) throw `Format: *.nenen Nama*`
...
if (command == 'wangy') {
if (!text) throw `Format: *.wangy Nama*`
...
if (command == 'curhat') {
if (!text) throw `Format: *.curhat Nama*`
...
if (command == 'perkosa') {
if (!text) throw `Format: *.perkosa Nama*`
